...
try {
	if ( nPartnerCookieValue != '' && window._VIEW_PARTNER_HEADER != false ) {
		...
		}else if(  nPartnerCookieValue == '2040' || nPartnerCookieValue == '2041' ){
			partnerHeaderInfo = '<div style="text-align:center"><img src="http://i.011st.com/ui_img/cm_display/2016/10/IM/Only_for/top_banner_onlyfor_01.jpg" alt="Only for 청춘 과제 노잼! 쇼핑 꿀잼!" width="980px" height="142px" border="0"></div>';
			partnerHeaderHeight = 142;
